...
public class LisExec {
	...
	public static void main(String[] args) {
		...
		Collections.sort(minhaLista);// utilizando o método sort da Collections para ordenar os elementos da minha
										// lista
		System.out.println("\nDepois de ordenado...");
		...
		Iterator<Integer> iMeuSet = meuSet.iterator();// criando um modificador através da API Iterator para poder
														// manipular o HashSet
