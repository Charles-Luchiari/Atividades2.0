...
public class Matrizes {
	...
	public static void main(String[] args) {
		...
		linhaUsuario = leia.nextInt();// 0
		System.out.println("\nQual a coluna que deseja ver a informação: ");
		colunaUsuario = leia.nextInt();// 2

		System.out.println("\nInformação na linha " + linhaUsuario + " e na coluna " + colunaUsuario + " tem o valor: "
				+ numeros[linhaUsuario][colunaUsuario]);
